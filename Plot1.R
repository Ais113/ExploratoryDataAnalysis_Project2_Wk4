...
#ASSIGN COLOURS TO USE IN CHART
colors()
Blues <- colorRampPalette(c("aquamarine", "azure2", "steelblue1", "blue"))
split_Blues <- Blues(4)[cut(AnnualEmission, breaks = 4)]


#PLOT CHART
png("plot1.png", width = 480, height = 480)

    barplot(AnnualEmission/1000000, 
        xlab = "Year", 
        ylab = expression("Total PM"[2.5]*" Emissions (millions tonnes)"), 
        main = expression("Total PM"[2.5]*" Emissions By Year: United States"),
        col  = split_Blues)
